...
final case class ShuffleResponse(
    ...
    def companion: shuffling.shuffling.ShuffleResponse.type = shuffling.shuffling.ShuffleResponse
    // @@protoc_insertion_point(GeneratedMessage[shuffling.ShuffleResponse])
}
...
object ShuffleResponse extends scalapb.GeneratedMessageCompanion[shuffling.shuffling.ShuffleResponse] {
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[shuffling.shuffling.ShuffleResponse] = _root_.scalapb.descriptors.Reads{
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = ShufflingProto.javaDescriptor.getMessageTypes().get(1)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = ShufflingProto.scalaDescriptor.messages(1)
